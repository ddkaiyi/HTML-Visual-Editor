...
> **Download (click to open):** [HtmlEditorLauncher.exe](https://github.com/ddkaiyi/HTML-Visual-Editor/blob/main/HtmlEditorLauncher.exe)  
> Then click **Download** on that page to save the file.

> 中文版：[README_CN.md](./README_CN.md)

This tool was originally an **HTML visual editor**. To protect the source code, it is packaged as a Windows executable (`.exe`) for distribution. **The HTML source is not provided.** You only need to download `HtmlEditorLauncher.exe`.

## Quick Start

1. Open [`HtmlEditorLauncher.exe`](https://github.com/ddkaiyi/HTML-Visual-Editor/blob/main/HtmlEditorLauncher.exe)
2. Download it, then double-click to run (no install required)
3. In the editor, click **Import HTML File**, or **Import HTML Code** to paste a full HTML document
4. Switch to **Edit Mode**, click elements to edit, then click **Export** when done
...
| File | Description |
| --- | --- |
| [HtmlEditorLauncher.exe](https://github.com/ddkaiyi/HTML-Visual-Editor/blob/main/HtmlEditorLauncher.exe) | Windows installer (download this file to use the app) |
